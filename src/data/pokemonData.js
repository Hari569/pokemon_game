...
export const MOVES = {
  ...
  EMBER: { name: 'Ember', type: TYPES.FIRE, power: 40, accuracy: 100 },
  FLAMETHROWER: { name: 'Flamethrower', type: TYPES.FIRE, power: 90, accuracy: 100 },
  ...
  THUNDER_SHOCK: { name: 'Thunder Shock', type: TYPES.ELECTRIC, power: 40, accuracy: 100 },
  ...
  POISON_STING: { name: 'Poison Sting', type: TYPES.POISON, power: 15, accuracy: 100 },
  STRING_SHOT: { name: 'Tackle', type: TYPES.NORMAL, power: 40, accuracy: 100 },
...
export const POKEMON_DATA = {
  ...
  IVYSAUR: {
    ...
    moves: [MOVES.VINE_WHIP, MOVES.RAZOR_LEAF],
  ...
  WARTORTLE: {
    ...
    moves: [MOVES.WATER_GUN, MOVES.SURF],
    evolutionLevel: 36, evolvesTo: null,
  },
  // Wild Pokemon
  PIDGEY: {
  ...
  RATTATA: {
    ...
    moves: [MOVES.TACKLE, MOVES.QUICK_ATTACK],
    evolutionLevel: null, evolvesTo: null,
  },
  PIKACHU: {
  ...
  WEEDLE: {
    ...
    moves: [MOVES.POISON_STING, MOVES.TACKLE],
    evolutionLevel: null, evolvesTo: null,
  },
  ZUBAT: {
